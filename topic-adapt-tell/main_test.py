...
flags.DEFINE_string("load_ckpt", 
        './checkpoint_m/mscoco/G_pretrained/G_pretrained-72000', 
...
flags.DEFINE_string("topic", "美食", "")
flags.DEFINE_string("tendency", "正", "")
flags.DEFINE_string("themes", "划算_好吃_粥_便宜_不贵_菜_质量_味道", "")
flags.DEFINE_integer("caption_nums", 5, "")
...
def main(_):
    ...
    with tf.Session(config=config) as sess:
        ...
        if FLAGS.D_is_pretrain:
            print('D_is_pretrain:', FLAGS.D_is_pretrain)
